<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="Product_Details.aspx.cs" Inherits="ECommProject.Pages.Product_Details" %>
...
<!-- Sidebar end=============================================== -->
	<div class="span9">
    <ul class="breadcrumb">
    <li><a href="../Body.aspx">Home</a> <span class="divider">/</span></li>
    <li><asp:HyperLink ID="productpageURL" runat="server">Products</asp:HyperLink> <span class="divider">/</span></li>
	...
	<div class="row">	  
			...
			<div id="differentview" class="moreOptopm carousel slide">
                <div class="carousel-inner">
                  <div class="item active">
                   ...
                   <a href="../Images/no-image-available.jpg"> <img style="width:29%" src="../Images/no-image-available.jpg" alt=""></a>
                   <a href="../Images/no-image-available.jpg"> <img style="width:29%" src="../Images/no-image-available.jpg" alt=""></a>
                   <a href="../Images/no-image-available.jpg"> <img style="width:29%" src="../Images/no-image-available.jpg" alt=""></a>
                  </div>
                  <div class="item">
			...
			<div class="span6">
				<h3><asp:Label runat="server"  ID="PName"></asp:Label></h3>
				<small><asp:Label runat="server"  ID="Pdeption"></asp:Label></small>
				<hr class="soft">
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<%--<label class="control-label"><span>$222.00</span></label>--%>
					  <asp:Label runat="server"  ID="Pprice"></asp:Label>
					<div class="controls">
					<input type="number" class="span1" placeholder="Qty.">
						<button type="submit" class="btn btn-large btn-primary pull-right" onclick="addtocart(<%=productid%>)"> Add to cart <i class="icon-shopping-cart"></i></button>
